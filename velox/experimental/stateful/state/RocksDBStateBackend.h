...
class RocksDBStateBackend : public StateBackend {
 public:
  RocksDBStateBackend(
      const std::shared_ptr<const RocksDBKeyedStateBackendParameters> params)
      : StateBackend(
            std::dynamic_pointer_cast<const KeyedStateBackendParameters>(
                params)) {}
...
class RocksDBKeyedStateBackendParameters : public KeyedStateBackendParameters {
 public:
  ...
  static std::shared_ptr<const RocksDBKeyedStateBackendParameters> create(
 ...
 private:
  ...
  /// The list of state names, related to the states have been registered in
  /// rocksdb state backend. It's used to justify the given state name is valid
  /// or not.
