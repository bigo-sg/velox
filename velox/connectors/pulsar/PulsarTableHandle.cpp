...
std::string PulsarTableHandle::toString() const {
...
folly::dynamic PulsarTableHandle::serialize() const {
  folly::dynamic obj = ConnectorTableHandle::serializeBase("PulsarTableHandle");
...
ConnectorTableHandlePtr PulsarTableHandle::create(
  ...
  return std::make_shared<const PulsarTableHandle>(
      connectorId, tableName, dataColumns, tableParameters);
}

void PulsarTableHandle::registerSerDe() {
  auto& registry = DeserializationWithContextRegistryForSharedPtr();
  registry.Register("PulsarTableHandle", create);
}
